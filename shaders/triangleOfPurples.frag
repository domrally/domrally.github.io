                            ...
                            min(lengths0.g,
                                ...
                                */
                                ...
                                void main()
                                {
                                    ...
                                    float l=mix(1.,39.,uv.y);
                                    float t=max(l-32.,0.)/(39.-32.);
                                    // float h=mix(12.2,37.1,t);
                                    
                                    float h=mix(mix(dark,blue,t),mix(dark,purp,t),uv.x);
                                    // float l=mix(32.,39.,uv.y);
                                    float s=mix(0.,100.,uv.x);
                                    
                                    vec3 color=hsluvToRgb(h,s,l);
                                    // float fade=clamp(2.*length(uv-.5),-1.,1.);
